...
1. Launch the CloudFormation Stack [Here](https://console.aws.amazon.com/cloudformation/home?region=ap-southeast-1#/stacks/new?stackName=GuardDuty-Hands-On&templateURL=https://securityroadshowbucket.s3-ap-southeast-2.amazonaws.com/cloudtrail-config-guardduty.yaml) to setup the  environment
